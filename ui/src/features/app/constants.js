...
export const MIN_AI_SUMMARY_FONT_SIZE_PX = 14;
export const MAX_AI_SUMMARY_FONT_SIZE_PX = 24;
export const DEFAULT_AI_CHAT_FONT_SIZE_PX = 14.4;
export const MIN_AI_CHAT_FONT_SIZE_PX = 13;
export const MAX_AI_CHAT_FONT_SIZE_PX = 22;
